...
You receive up to five things via your Task prompt:
...
3. **Task code map** (optional) - Path to task-scoped code context. Use it to understand affected files and behaviors, but verify browser behavior directly.
4. **Reproduction steps** (optional) - Numbered steps to reproduce the original issue, plus the affected URL
5. **Output directory** - Where to write the verification report and screenshots (e.g., `<fixme-dir>/verifications/`)
