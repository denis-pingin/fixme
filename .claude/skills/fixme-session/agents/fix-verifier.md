...
tools: Read, Write, Edit, Bash, Bash(playwright-cli:*), Bash(mkdir *), Bash(node ~/.claude/skills/fixme-session/scripts/fixme-tools.cjs *), Glob, Grep
model: inherit
skills:
  - playwright-cli
---
...
```bash
node ~/.claude/skills/fixme-session/scripts/fixme-tools.cjs ticket transition <ticket-folder>/ticket.md verifying
```
