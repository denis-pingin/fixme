...
Your job: Read the findings, the plan, the spec, and the implementation. Classify each finding using the unified taxonomy. Output HANDLER_RESULT: CLEAN, HAS_FIX, or HAS_ASK_USER.
